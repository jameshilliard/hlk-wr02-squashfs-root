...
function initTranslation()
{
	...
	e = document.getElementById("wWiFiSSID");
	e.innerHTML = _("inet wifissid");
	e = document.getElementById("wWiFiPassword");
	e.innerHTML = _("inet wifipass");
	e = document.getElementById("wWANIP");
	e.innerHTML = _("inet wanip_");
...
<form method=post name="wanCfg" action="/goform/setWan2" onSubmit="return CheckValue()">
...
<tr>
  <td class="head" id="wWiFiSSID">WiFi SSID</td>
  <td><input name="WiFiSSID" maxlength=32 size=32
             value="<% getCfgGeneral(1, "SSID1"); %>"></td>
</tr>
<tr>
  <td class="head" id="wWiFiPassword">WiFi Password</td>
  <td><input name="WiFiPassword" maxlength=32 size=32
             value="<% getCfgGeneral(1, "WPAPSK1"); %>"></td>
</tr>
<tr>
  <td class="head" id="wWANIP">WAN IP</td>
  <td><% getWanIp(); %></td>
</tr>
