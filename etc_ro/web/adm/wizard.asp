...
function initTranslation()
{
	...
	e = document.getElementById("Ttitle");
	e.innerHTML = _("wizard t11");
	
	e = document.getElementById("Tstep1");
	e.innerHTML = _("wizard t12");
	
	e = document.getElementById("Tstep2");
	e.innerHTML = _("wizard t13");

	e = document.getElementById("div_wan_title");
	e.innerHTML = _("wizard t21");
	e = document.getElementById("Tdhcp");
	e.innerHTML = _("wizard t22");
	e = document.getElementById("Tdhcp1");
	e.innerHTML = _("wizard t23");
	e = document.getElementById("Tstatic");
	e.innerHTML = _("wizard t24");
	e = document.getElementById("Tstatic1");
	e.innerHTML = _("wizard t25");
	e = document.getElementById("Tpppoe");
	e.innerHTML = _("wizard t26");
	e = document.getElementById("Tpppoe1");
	e.innerHTML = _("wizard t27");
	e = document.getElementById("Tl2tp1");
	e.innerHTML = _("wizard t28");
	e = document.getElementById("Tppptp1");
	e.innerHTML = _("wizard t29");
	e = document.getElementById("T3g1");
	e.innerHTML = _("wizard t2a");
	
	e = document.getElementById("div_wireless_title");
	e.innerHTML = _("wizard t31");
	e = document.getElementById("Twireless2");
	e.innerHTML = _("wizard t32");
	e = document.getElementById("Twireless3");
	e.innerHTML = _("wizard t33");
	e = document.getElementById("Twireless4");
	e.innerHTML = _("wizard t34");
	e = document.getElementById("Twireless41");
	e.innerHTML = _("wizard t35");

	e = document.getElementById("back_motion");
	e.value = _("wizard back");
	e = document.getElementById("next_motion");
	e.value = _("wizard next");
	e = document.getElementById("cancel_motion");
	e.value = _("wizard cancel");
	e = document.getElementById("apply_motion");
	e.value = _("wizard apply");
...
<h1 id="Ttitle">Quick Settings</h1>
<p></p>
<hr />
...
<tr><th align="left" id="Tstep1">Step 1: configure Internet connection</th></tr>
<tr><th align="left" id="Tstep2">Step 2: configure Wireless Settings</th></tr>
</table>
...
<tr>
  ...
  <th align="left" id="Tdhcp">DHCP (Auto Config)</th>
</tr>
<tr>
  <td>&nbsp; &nbsp;</td>
  <td id="Tdhcp1">Choose this, ISP automatically configure this device.</td>
</tr> 
<tr>
  <td width="15px"><input type="radio" name="connectionType" value="STATIC"></td>
  <th align="left" id="Tstatic">Static Mode (fixed IP)</th>
</tr>
<tr>
  <td>&nbsp; &nbsp;</td>
  <td id="Tstatic1">Choose this, user need to configure this device manually.</td>
</tr>
  <td width="15px"><input type="radio" name="connectionType" value="PPPOE"></td>
  <th align="left" id="Tpppoe">PPPOE (ADSL)</th>
</tr>
<tr>
  <td>&nbsp; &nbsp;</td>
  <td id="Tpppoe1">Choose this, user must input a username and password for ISP authenticator.</td>
</tr>
<tr>
...
<tr>
  <td>&nbsp; &nbsp;</td>
  <td align="left" id="Tl2tp1">L2TP Client</td>
</tr>
<tr>
...
<tr>
  <td class="title" colspan="2" id="Tstamode1">Static Mode</td>
</tr>
<tr>
  <td class="head" id="Tstamode2">IP Address</td>
  <td><input name="staticIp" maxlength=15></td>
</tr>
<tr>
  <td class="head" id="Tstamode3">Subnet Mask</td>
  <td><input name="staticNetmask" maxlength=15>
  </td>
</tr>
<tr>
  <td class="head" id="Tstamode4">Default Gateway</td>
  <td><input name="staticGateway" maxlength=15>
  </td>
</tr>
<tr>
  <td class="head" id="Tstamode5">Primary DNS Server</td>
  <td><input name="staticPriDns" maxlength=15></td>
</tr>
<tr>
  <td class="head" id="Tstamode6">Secondary DNS Server</td>
...
<tr>
  <td class="title" colspan="2" id="Tpppoemode1">PPPoE Mode</td>
</tr>
<tr>
  <td class="head" id="Tpppoemode2">User Name</td>
  <td><input name="pppoeUser" maxlength=32 size=32></td>
</tr>
<tr>
  <td class="head" id="Tpppoemode3">Password</td>
  <td><input type="password" name="pppoePass" maxlength=32 size=32></td>
</tr>
<tr>
  <td class="head" id="Tpppoemode4">Verify Password</td>
  <td><input type="password" name="pppoePass2" maxlength=32 size=32></td>
</tr>
<tr id="div_pppoe_opmode">
  <td class="head" rowspan="2" id="Tpppoemode5">Operation Mode</td>
  <td>
...
<tr><td class="title" colspan="2" id="Twireless2">Wireless Settings</td></tr>
<tr>
  <td class="head" id="Twireless3">Network Name (SSID)</td>
  <td><input type="text" name="ssid" size="20" maxlength="32"></td>
</tr>
<tr>
  <td class="head" rowspan="2" id="Twireless4">Security</td>
  <td>
    <select name="security_mode" size="1" onChange="switch_security_mode();">
      <option id="Twireless41" value="Disable" selected>Disable</option>
...
<tr id="div_security_key">
  <td id="Twireless5">KEY:<input type="text" name="security_key" size="28" maxlength="64"></td>
</tr>
</table>
...
<tr align="center">
  <td>
    <input type="button" name="back_motion" id="back_motion" style="{width:120px;}" value="Back" onClick="change_step(-1);">
    <input type="button" name="next_motion" id="next_motion" style="{width:120px;}" value="Next" onClick="change_step(1);">
    <input type="button" name="cancel_motion" id="cancel_motion" style="{width:120px;}" value="Cancel" onClick="change_step(0);">
    <input type="button" name="apply_motion" id="apply_motion" style="{width:120px;}" value="Apply" onClick="change_step(1);">
  </td>
</tr>
</table>
</form>
